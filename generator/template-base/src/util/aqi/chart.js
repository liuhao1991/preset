    ...
    series: [
      {
        ...
        progress: {
          ...
          roundCap: location == "home" ? false : true,
          borderWidth: 2,
          borderColor: "#FFF",
        },
        center: ["50%", "85%"],
...
const handlerAqiChart = (data) => {
  ...
  const aqiList = (value) => {
    let itemx = AQIList.find((item, index) => {
...
const handlerPM25Chart = (data) => {
  ...
  const pm25List = (value) => {
    // let itemx = ''
    let itemx = PM25List.find((item, index) => {
      if (Math.max(...value) > item) {
        if (index === 5) {
          return AQIList[index + 1];
        }
...
const handlerPM10Chart = (data) => {
  ...
  const pm10List = (value) => {
    // let itemx = ''
    let itemx = PM10List.find((item, index) => {
      if (Math.max(...value) > item) {
        if (index === 5) {
          return AQIList[index + 1];
        }
...
const handlerO3Chart = (data) => {
  ...
  const o3List = (value) => {
    // let itemx = ''
    let itemx = O3List.find((item, index) => {
      if (Math.max(...value) > item) {
        if (index === 5) {
          return AQIList[index + 1];
        }
...
const handlerNO2Chart = (data) => {
  ...
  const no2List = (value) => {
    // let itemx = ''
    let itemx = NO2List.find((item, index) => {
      if (Math.max(...value) > item) {
        if (index === 5) {
          return AQIList[index + 1];
        }
...
const handlerSO2Chart = (data) => {
  ...
  const so2List = (value) => {
    // let itemx = ''
    let itemx = SO2List.find((item, index) => {
      if (Math.max(...value) > item) {
        if (index === 5) {
          return AQIList[index + 1];
        }
...
const handlerCOChart = (data) => {
  ...
  const coList = (value) => {
    let itemx = COList.find((item, index) => {
      if (Math.max(...value) > item) {
        if (index === 5) {
          return AQIList[index + 1];
        }
